        ...
        <div className="intro-box-flip">
          <div className="flip-inner">
            <div className="flip-front">
              <img src={process.env.PUBLIC_URL + '/castillaLogoCompleto.png'} alt="Logo completo" className="logo-grande" />
            </div>
            <div className="flip-back">
              <img src={process.env.PUBLIC_URL + '/castillaLogoCompleto.png'} alt="Logo pequeño" className="logo-pequeno" />
